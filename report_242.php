...
<div align="center">
            <strong>รายละเอียดสถานประกอบการที่ไม่เข้าข่าย <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?><br />
</strong>
              <br>
</div>
...
<table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:18px;"<?php }?>>
      ...
      <tr >
        ...
        <td width="0" rowspan="3" align="center" valign="bottom"><div align="center"><strong>จำนวนลูกจ้าง</strong></div></td>
  ...
  <br />(ราย)
	  ...
	  ?>
              ...
              <tr>
                ...
                <td width="<?php echo $w75?>" align="right"  valign="top"><div align="right"><?php echo $lawful_row["company_employees"]?></div></td>
                ...
                <?php
                    ...
                    <td width="<?php echo $w75?>" align="right"  valign="top"><div align="right"><?php echo $curator_user;?></div></td>
                        ...
                        <?php if($lawful_row["LawfulStatus"] == 0){echo '<span style="color:red">ไม่ปฏิบัติตามกฎหมาย</span>';}?>
                        <?php if($lawful_row["LawfulStatus"] == 1){echo '<span style="color:red">ปฏิบัติตามกฎหมาย</span>';}?>
                          <?php if($lawful_row["LawfulStatus"] == 2){echo '<span style="color:red">ปฏิบัติตามกฏหมายแต่ไม่ครบตามอัตราส่วน</span>';}?>

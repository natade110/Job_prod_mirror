...
*</td>
                      ...
                      <tr>
                        <td colspan="4">
                          <div align="left">
                          	<hr />
                            <?php if($mode == "edit" && $sess_accesslevel != 4 && $sess_accesslevel != 5){?>
                                   ...
                                   <?php if($sess_accesslevel !=4){?>
                                    	...
                                    	<tr>
                                    	  ...
                                    	  <td colspan="2" style="padding-left: 30px;"><table border="0">
											  ...
											  ?>:1 = <strong id="employee_ratio"><?php 
											  	...
											  	if(($employee_to_use/$ratio_to_use)>1 || $employee_to_use == $ratio_to_use){
													...
													if($left_over <= $half_ratio_to_use){
														echo formatEmployee(floor($employee_to_use/$ratio_to_use));
													}else{
														echo formatEmployee(ceil($employee_to_use/$ratio_to_use));
													}
                                            ...
                                            <tr>
                                              ...
                                              <td><input name="Hire_NumofEmp" type="text" id="Hire_NumofEmp" size="10" value="<?php echo formatEmployee(default_value($lawful_values["Hire_NumofEmp"],"0"));?>" onchange=" addEmployeeCommas('Hire_NumofEmp');"/> 
                                             ...
                                             <tr>
                                              ...
                                              <td><input name="Hire_NewEmp" type="text" id="Hire_NewEmp" size="10" value="<?php echo formatEmployee(default_value($lawful_values["Hire_NewEmp"],"0"));?>" onchange=" addEmployeeCommas('Hire_NewEmp');"/> 
                                              คน
                                            </tr>
                                            <tr>
                                              <td>เอกสารประกอบ</td>
                                    ...
                                    <table>
                                      ...
                                      <tr>
                                       ...
                                       <?php //if($sess_accesslevel ==4){
											 if(1==1){?>
                                             	ส่งเงินเข้ากองทุนฯแทนการรับคนพิการ
                                             <?php }else{ ?>
                                            	ปฏิบัติตามมาตรา 34
                                             <?php } ?>
                                        </span></td>
                                      ...
                                      <tr >
                                        ...
                                        <table border="0" >
                                          ...
                                          <tr>
                                            ...
                                            <?php 
												...
												$the_sql = "select * from payment, receipt , lawfulness
															...
															and
															lawfulness.CID = '".$this_id."' order by receipt.RID desc";
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="4"><hr /><a href="org_list.php?search_id=<?php echo $this_id?>&mode=payment&for_year=<?php echo $this_lawful_year;?>" style="font-weight: bold;">+ เพิ่มข้อมูลการส่งเงินเข้ากองทุน</a></td>
                                          </tr>
                                          <?php } ?>
...
<table border="0" style="margin-left:75px; ">
        	<tr>
            	<td>
                <input name="Conc1_status" type="checkbox" id="Conc1_status" value="1" <?php echoChecked($lawful_values["Conc1_status"])?>/>              
                </td>
                <td colspan="2">
                <strong>การให้สัมปทาน</strong>
                </td>
            </tr>
            <tr>
            	<td>
                ...
                <td>
                  ...
                  <div style="width:400px; padding-bottom:5px;">
                    <?php 
                        ...
                        $file_type = "Conc1_docfile";                    
                        include "doc_file_links.php";
						
						$this_id = $this_id_temp;
                    ?>
                    </div><input type="file" name="Conc1_docfile" id="Conc1_docfile" />
                 
                </td>
            </tr> 
            <tr>
            	<td>
                <input name="Conc2_status" type="checkbox" id="Conc2_status" value="1" <?php echoChecked($lawful_values["Conc2_status"])?>/>              
                </td>
                <td colspan="2">
                <strong>การจัดสถานที่จำหน่ายสินค้าหรือบริการ</strong>
                </td>
            </tr>
            <tr>
            	<td>
                ...
                <td>
                  ...
                  <div style="width:400px; padding-bottom:5px;">
                    <?php 
                        ...
                        $file_type = "Conc2_docfile";                    
                        include "doc_file_links.php";
						
						$this_id = $this_id_temp;
                    ?>
                    </div><input type="file" name="Conc2_docfile" id="Conc2_docfile" />
                 
                </td>
            </tr> 
            <tr>
            	<td>
                <input name="Conc3_status" type="checkbox" id="Conc3_status" value="1" <?php echoChecked($lawful_values["Conc3_status"])?>/>              
                </td>
                <td colspan="2">
                <strong>การจัดจ้างเหมาช่วงงาน</strong>
                </td>
            </tr>
            <tr>
            	<td>
                ...
                <td>
                  ...
                  <div style="width:400px; padding-bottom:5px;">
                    <?php 
                        ...
                        $file_type = "Conc3_docfile";                    
                        include "doc_file_links.php";
						
						$this_id = $this_id_temp;
                    ?>
                    </div><input type="file" name="Conc3_docfile" id="Conc3_docfile" />
             ...
             <tr>
            	<td>
                <input name="Conc4_status" type="checkbox" id="Conc4_status" value="1" <?php echoChecked($lawful_values["Conc4_status"])?>/>              
                </td>
                <td colspan="2">
                <strong>การฝึกงาน</strong>
                </td>
            </tr>
            <tr>
            	<td>
                ...
                <td>
                  ...
                  <div style="width:400px; padding-bottom:5px;">
                    <?php 
                        ...
                        $file_type = "Conc4_docfile";                    
                        include "doc_file_links.php";
						
						$this_id = $this_id_temp;
                    ?>
                    </div><input type="file" name="Conc4_docfile" id="Conc4_docfile" />
             ...
             <tr>
            	<td>
                <input name="Conc5_status" type="checkbox" id="Conc5_status" value="1" <?php echoChecked($lawful_values["Conc5_status"])?>/>              
                </td>
                <td colspan="2">
                <strong>การช่วยเหลืออื่นใด</strong>
                </td>
            </tr>
            <tr>
            	<td>
                ...
                <td>
                  ...
                  <div style="width:400px; padding-bottom:5px;">
                    <?php 
                        ...
                        $file_type = "Conc5_docfile";                    
                        include "doc_file_links.php";
						
						$this_id = $this_id_temp;
                    ?>
                    </div><input type="file" name="Conc5_docfile" id="Conc5_docfile" />
 ...
 <div id="my_popup" style="position: absolute;  padding:3px; background-color:#006699; width: 1000px; display: none; " >
                                  ...
                                  <script language='javascript'>
                                    ...
                                    <?php
										...
										?>     
                                    <tr>
                                      <td><div align="center"><?php echo $total_records;?></div></td>
                                      <td><?php echo doCleanOutput($post_row["le_name"]);?></td>
                                      <td><?php echo formatGender($post_row["le_gender"]);?></td>
                                      <td><?php echo doCleanOutput($post_row["le_age"]);?></td>
                                      <td><?php echo doCleanOutput($post_row["le_code"]);?></td>
                                      <td><?php echo doCleanOutput($post_row["le_disable_desc"]);?></td>
                                      <td><?php echo formatDateThai($post_row["le_start_date"],0);?></td>
                                      <td><div align="right"><?php echo formatNumber($post_row["le_wage"]);?></div></td>
                                      <td><?php echo doCleanOutput($post_row["le_position"]);?></td>
                                     
                                     <?php if($sess_accesslevel != 5 ){?>
                                          <td><div align="center"><a href="scrp_delete_lawful_employee.php?id=<?php echo doCleanOutput($post_row["le_id"]);?>&cid=<?php echo $this_id;?>&year=<?php echo $this_lawful_year;?>" title="ลบข้อมูล" onclick="return confirm('คุณแน่ใจหรือว่าจะลบข้อมูล? การลบข้อมูลถือเป็นการสิ้นสุดและคุณจะไม่สามารถแก้ไขการลบข้อมูลได้');"><img src="decors/cross_icon.gif" alt="" border="0" /></a></div></td>
                                      <?php }?>

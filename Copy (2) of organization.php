                                          ...
                                          <tr>
                                            <td>
                                                ...
                                                <?php
													...
													$interest_date = dateDiffTs(strtotime(date("2012-02-01")), strtotime(date("Y-m-d")));
                                            	...
                                            	<table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <div align="right">
                                                        <?Php echo formatNumber($owned_money + $interest_money);?>                                                        </div>
                                                        </td>
...
<div align="center">
    	<table width="700">
        	<tr>
            	<td colspan="5">
              	<strong>ผู้ใช้สิทธิ</strong> <a href="#" onclick="doPopSubCurator('0'); fireMyPopup('35_popup',1020,160); return false;">
                                	+ เพิ่มผู้ใช้สิทธิ
                                </a>
                </td>
            </tr>
			...
			?>
                 <tr >
                  ...
                  <td style="border-top:1px solid #999999;"><?php echo doCleanOutput($post_row["curator_idcard"]);?></td>
                	...
                	<td colspan="7">
                    	...
                    	<table width="500">
                            ...
                            <tr>
                                ...
                                <a href="#" onclick="doPopSubCurator('<?php echo $post_row["curator_id"];?>'); fireMyPopup('35_popup',1020,160); return false;">
                                	+ เพิ่มผู้ถูกใช้สิทธิ
                                </a>
								...
								?>
                                 ...
                                 <tr>
                                  <td><div align="center"><?php echo $total_sub;?></div></td>
                                  <td><?php echo doCleanOutput($sub_row["curator_name"]);?></td>
                                  <td><?php echo formatGender($sub_row["curator_gender"]);?></td>
                                  <td><?php echo doCleanOutput($sub_row["curator_age"]);?></td>
                                  <td><?php echo doCleanOutput($sub_row["curator_idcard"]);?></td>
                                  <td><?php echo doCleanOutput($sub_row["curator_disable_desc"]);?></td>
                                  <?php if($sess_accesslevel != 5 ){?>
...
<table border="0" style="margin-left:75px; ">
 ...
 <div id="35_popup" style=" position: absolute; padding:3px; background-color:#006699; width: 1000px;  " >

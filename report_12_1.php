...
if(isset($_POST["Section"]) && $_POST["Section"] != "" && $_POST["rad_area"] == "section"){
	...
	$province_filter = " and a.Province = provinces.province_id and provinces.section_id = '".$_POST["Section"]."'";
...
<div align="center">
            <strong>สรุปประเภทคนพิการที่ใช้สิทธิในมาตรา 35 ทั้งหมด <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?></strong>
              <br>
</div>
	  ...
	  for($i=0;$i<count($distype_array);$i++){
	  	...
	  	if($i == count($distype_array)-1){
			...
			for($mm=0;$mm<count($distype_array);$mm++){
				...
				$desc_filter .=  " and curator_disable_desc != '".$distype_array[$mm]."' ";
				
				$desc_filter_user .=  " and z.curator_disable_desc != '".$distype_array[$mm]."' ";
				
			}
			
			$desc_filter .=  " or(						
									curator_disable_desc = '' 
									or curator_disable_desc is null
								)";
			...
			$desc_filter_user .=  " or(						
									z.curator_disable_desc = '' 
									or z.curator_disable_desc is null
								)";
			...
			$desc_filter = "and curator_disable_desc = '".$distype_array[$i]."'";	
			
			//yoes 20221222
			$desc_filter_user = "and z.curator_disable_desc = '".$distype_array[$i]."'";	
		}

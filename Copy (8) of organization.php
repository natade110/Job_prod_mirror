...
if($_POST["do_add_curator"]){
	...
	$curator_value = doCleanInput($_POST["curator_value"]);
              ...
              <table cellspacing="0">
                                <tr>
                                  ...
                                  <?php
									...
									if(!$is_main_branch && $lawful_record < 1 && !$show_all_tabs){
							...
							?>
                                ...
                                <tr >
                                  <td valign="top">
                                    ...
                                    <td valign="top">
                                   	 <div align="right"><?php echo $employees_to_use;?></div>                                    </td>    
												...
												?>
                                                         ...
                                                         <?php if($sess_accesslevel != 4){?>
                                                            ...
                                                            <?php if($this_lawful_year >= 2012){ //only show interests when 2012+?>
                                                                            ...
                                                                            ดอกเบี้ย ณ วันที่จ่าย: <?php echo $interest_date;?> วัน x 7.5/100/<?php echo $year_date?> x <?php echo formatNumber($owned_money);?> = <?php echo formatNumber($interest_money - $total_pending_interest);?> บาท
                    ...
                    <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <div id="curator_is_disable">
                                <input name="curator_is_disable" type="radio" value="0" onClick="document.getElementById('tr_curator_disable').style.display = 'none';" checked="checked" /> ผู้ดูแลคนพิการ
                                   
                                <input name="curator_is_disable" type="radio" value="1" onClick="document.getElementById('tr_curator_disable').style.display = '';"/> คนพิการ
                            </div>
                            </td>
                        ...
                        <tr id="tr_curator_event" style="display: none;">
                          ...
                          <td >
                            ...
                            <td><input name="curator_value" id="curator_value" style="text-align:right;"  type="text" size="10" onChange="addCommas('curator_value');"/> บาท</td>
                        </tr>
			...
			?>
                 <tr >
                  ...
                  <td style="border-top:1px solid #999999;"><?php echo formatDateThai($post_row["curator_start_date"]);?></td>
					...
					echo dateDiffTs(strtotime($post_row["curator_start_date"]), strtotime($post_row["curator_end_date"]));
                                            ...
                                            <td>
                                             ...
                                             <?php
												...
												if(is_numeric($_GET["leid"])){
													...
													$leid_row = getFirstRow("select * from lawful_employees where le_id = '".$_GET["leid"]."'");

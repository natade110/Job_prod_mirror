...
$querySQL = "
		...
		and 
		(nepfundcanceldate is not null and nepfundcanceldate != '')
...
?>
	<div align="center">
		<strong>รายงานการยกเลิกการจ่ายเงินของระบบกรุงไทย Online<br />กองทุนส่งเสริมและพัฒนาคุณภาพชีวิตคนพิการแห่งชาติ</strong>
		<br />
	</div>
	<table border="1" align="center" cellpadding="5" cellspacing="0" style="border-collapse: collapse;font-size:<?php echo !$is_pdf ? 14:28; ?>px">
		<thead>
			<tr bgcolor="#9C9A9C" align="center">
				...
				<td align="center">ผู้ที่ทำการยกเลิกใบเสร็จ</td>
			</tr>
		</thead>
		<tbody>
		<?php

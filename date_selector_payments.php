...
?><select name="<?php echo $selector_name;?>_day" size="1" class="inputf" id="<?php echo $selector_name;?>_day" style="width:auto;" <?php echo $the_disabled;?> >

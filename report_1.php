...
(บาท)</strong></td>
	  ...
	  for($i=0; $i<count($row_name_array);$i++){
		...
		//yoes 20200916 -- add employees count
		$sql_lawful_employees_count = "
				select 
					sum(
						lawfulness.employees
		...
		$lawful_employees_count = getFirstItem($sql_lawful_employees_count);
		$total_lawful_employees_count += $lawful_employees_count;
		
		//echo $total_lawful_employees_count . "<br>";
      ...
      <tr>
        ...
        <td align="right"  valign="top"><div align="right">
			...
			echo formatEmployeeReport($this_emp);
			
			$row_data[$i][this_emp] = $this_emp;
        ...
        <td align="right"  valign="top">
        <?Php 
			echo formatEmployeeReport($curator_usee+$curator_user);		
			$row_data[$i][curators] = $curator_usee+$curator_user;
		?>
        </td>
        <td align="right"  valign="top">
        ...
        <?php 
			...
			$row_data[$i][all_34] = $all_34;
			$row_data[$i][this_rule_34] = $this_rule_35;
		?>
        ...
        <td align="right"  valign="top"><?php 
				...
				//yoes 20240710 -- quickfix for now
				if($_POST["Province"] == 36 && $the_year == 2024){
					//$incurred_extra_money = 0;
				}
				
				echo formatNumber($incurred_extra_money); $total_incurred_extra_money += $incurred_extra_money;

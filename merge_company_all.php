...
<?php include "header_html.php";?>
                ...
                <td valign="top" style="padding-left:5px;">
                    ...
                    <h2 class="default_h1" style="margin:0; padding:0 0 10px 0;"  >การรวมข้อมูลสถานประกอบการ</h2>
					...
					?>
                        ...
                        <font color="green">
                    	ทำการรวมข้อมูลสถานประกอบการเสร็จสิ้น
                        </font>
					...
					<form method="post">
                        ...
                        <strong>
                            ...
                            1. ใส่เลขที่บัญชีนายจ้างของสถานประกอบการที่ต้องการทำการรวมข้อมูล
					...
					?>
                    <form id="myForm" action="scrp_merge_company.php" method="post">
                    
                     <strong>
                     
                        2. เลือกสถานประกอบการที่จะใช้เป็นข้อมูลหลักจากรายชื่อด้านล่าง <br />- สถานประกอบการที่ไม่ได้ถูกเลืกจะถูกเอาออกจากระบบ และข้อมูลการปฏิบัติตามกฎหมายทั้งหมดจะถูกย้ายไปอยู่กับสถานประกอบการที่ถูกเลือก
                    ...
                    <table cellpadding="5" bgcolor="#FFFFFF" border="1" style=" margin: 10px 0; border: 1px solid #000; border-collapse: collapse;">
                        ...
                        <tr>
                           ...
                           เลขที่สาขา
                            ...
                            <td align="center" bgcolor="#efefef" style="text-align: center"> รหัสสถานประกอบการ </td>
                           ...
                           วันที่สร้างข้อมูลสถานประกอบการ
                            </td>
						...
						if(!$is_school){
							...
							echo "<font color=red>
									...
									สถานประกอบการที่ต้องการทำการรวมข้อมูล ไม่ประกอบด้วยสถานประกอบการเอกชนอย่างน้อยหนึ่งแห่ง - กรุณาใส่เลขที่บัญชีนายจ้างที่ประกอบด้วยสถานประกอบการเอกชน
                   ...
                   <?php if($is_school){?>
                        ...
                        3. ข้อมูลการปฏบัติตามกฏหมายของทุกปี(ถ้ามี) จะถูกรวมไปไว้ในสถานประกอบการที่ถูกเลือก - ข้อมูลการปฏิบัติตามกฏหมายจะถูกรวมตามตารางสรุปด้านล่าง
                     ...
                     <table cellpadding="5" bgcolor="#FFFFFF" border="1" style="  margin: 10px 0; border: 1px solid #000; border-collapse: collapse;">
                    	...
                    	<tr>
                         ...
                         4. หลังจากตรวจสอบข้อมูลพร้อมแล้ว - คลิกที่ปุ่มด้านล่างเพื่อทำการรวมข้อมูลสถานประกอบการ
                         
                         </strong>
                    
                    	<div style="padding-top: 10px;">
	                    	<input type="submit" value="ทำการรวมข้อมูลสถานประกอบการ" onclick="return doCheckRadio(); " />
                        ...
                        <script>
							...
							function doCheckRadio(){
								...
								if($('input[name=main_cid]:checked', '#myForm').val() == undefined){
									//alert('no');	
									alert("กรุณาเลือกสถานประกอบการที่จะใช้เป็นข้อมูลหลักจากข้อ (2)");
									return false;
								}else{
									//alert('yes');	
									return confirm('ต้องการรวมข้อมูลสถานประกอบการหรือไม่  การรวมข้อมูลจะไม่สามารถทำการย้อนกลับเป็นเหมือนเดิมได้');
								}

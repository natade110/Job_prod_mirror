...
if($_POST["report_format"] == "excel"){
	...
	header("Content-Disposition: attachment; filename=report_25.xls");
	$is_excel = 1;
...
$main_sql = "
				  ...
				  from
					lawful_employees
						...
						join company
							on
							lawful_employees.le_cid = company.cid
							$typecode_filter
							
					
				   where le_year = '$the_year'
...
<div align="center">
            <strong>รายงานคนพิการปฏิบัติตามกฎหมายซ้ำซ้อน <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?></strong>
              <br>
</div>
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:18px;"<?php }?>>
      ...
      <tr >
        <td width="<?php echo $w50;?>" rowspan="2" align="center"  valign="bottom"><div align="center" style="vertical-align:bottom;"><strong>ลำดับที่ </strong></div></td>
        <td width="<?php echo $w350+25;?>" colspan="5" align="center"  valign="bottom"><div align="center" style="vertical-align:middle;"><strong>รายละเอียดผู้ใช้สิทธิ</strong> </div></td>
        <td width="<?php echo $w75;?>" rowspan="2" align="center" valign="bottom" ><div align="center" style="vertical-align:bottom;"><strong>การปฏิบัติ<?php if(!$is_pdf){?><br /><?php }?>ตามกฎหมาย</strong></div></td>
        <td width="<?php echo $w75 +$w100+$w75+$w75+$w75+$w50;?>" colspan="5" align="center" valign="bottom" ><div align="center"><strong>รายละเอียดสถานประกอบการ</strong></div></td>
        </tr>
      <tr >
        <td width="<?php echo $w100;?>" align="center" valign="bottom"><div align="center" style="vertical-align:middle;"><strong>เลขที่บัตรประชาชน</strong> </div></td>
        <td width="<?php echo $w75;?>" align="center" valign="bottom"><div align="center" style="vertical-align:middle;"><strong>ชื่อ - นามสกุล</strong> </div></td>
        ...
        <td width="<?php echo $w125;?>" align="center" valign="bottom"><div align="center" style="vertical-align:middle;"><strong>ประเภทความพิการ</strong></div></td>
        <td width="<?php echo $w50;?>" align="center" valign="bottom" ><div align="center"><strong>สถานะ</strong></div></td>
        <td width="<?php echo $w75;?>" align="center" valign="bottom" ><div align="center"><strong>ชื่อสถานประกอบการ</strong></div></td>
        <td width="<?php echo $w75;?>" align="center" valign="bottom" ><div align="center"><strong>ที่ตั้ง</strong></div></td>
        <td width="<?php echo $w75;?>" align="center" valign="bottom" ><div align="center"><strong>วันเริ่มงาน/เริ่มสัญญา</strong></div></td>
        <td width="<?php echo $w100;?>" align="center" valign="bottom" ><div align="center"><strong>ตำแหน่งงาน/ลักษณะสัมปทาน</strong></div></td>
        <td width="<?php echo $w75;?>" align="center" valign="bottom" ><div align="center"><strong>เงินเดือน/มูลค่าสัมปทาน </strong></div></td>
        </tr>
      </thead>
       ...
       <?php
		  ...
		  while ($lawful_row = mysql_fetch_array($lawful_result)) {
			...
			$the_code_sql = "
						...
						select
						 ...
						 select
							...
							, '35' as the_type
							, b.cid as the_cid
							, curator_start_date as the_date
							, curator_event as the_position
							, curator_value as the_wage
							, Year as the_year
							, curator_parent as the_parent
			...
			while ($the_code_row = mysql_fetch_array($the_code_result)) {
				...
				//yoes 20160707 -- also forma position
				if(is_numeric(trim($the_code_row["the_position"]))){
					
					$the_code_row["the_position"] = getFirstItem("select group_name from position_group where group_id = '".$the_code_row["the_position"]."'");
						
				}
				//yoes 20160707
				//also check if have parent -> is so, show parent details instead...
				if($the_code_row["the_parent"]){
					
					$parent_row = getFirstRow("select * from curator where curator_id = '".($the_code_row["the_parent"]*1)."'");
					
					$the_code_row["the_date"] = $parent_row[curator_start_date];
					$the_code_row["the_position"] = $parent_row[curator_event];
					$the_code_row["the_wage"] = $parent_row[curator_value];
				}

											...
											<script>
												...
												function doGetCompanyInfo(){
												   ...
												   if (!allValid)
												   {
													...
													$.ajax({
													  method: "POST",
													  url: "ajax_get_juristic_from_dbd.php",
													  //dataType: 'jsonp',
													  //url: "ajax_get_sso.php",
													  data: { name: "John", location: "Boston", the_id: the_id, the_user: <?php echo $sess_userid;?>, CompanyCode: <?php echo $output_values["CompanyCode"];?>}
													})
													  .done(function( html ) {
							...
							if($courted_flag){?>
								...
								<tr>
										  ...
										  <div align="center">
												...
												<br>ในกรณีที่ต้องการ <font color=blue>ยกเลิกการส่งข้อมูลดำเนินคดีตามกฏหมาย</font> สามารถทำได้โดยการกดปุ่มด้านล่าง
												<br>** สิทธิการยกเลิกการส่งข้อมูลดำเนินคดีตามกฏหมาย สามารถทำได้โดยกลุ่มงานคดีเท่านั้น 
												<br> หลังจากยกเลิกการส่งข้อมูลดำเนินคดีตามกฏหมายแล้วเจ้าหน้าที่กลุ่มงานคดีจะ<u>ไม่สามารถแก้ไข</u>ข้อมูลสถานประกอบการนี้ได้ <br>จนกว่าจะมีการยื่นส่งข้อมูลดำเนินคดีตามกฏหมายมาอีกครั้ง
											  
											  
											  
												<form method="post" action="./scrp_do_open_court.php" >
            ...
            <table style=" padding:10px 0 0px 0; " id="input">
					...
					<tr>
                    	<td>
							...
							// DANG
							$sql = "SELECT *
									FROM company_company c left join provinces p on c.Province = p.province_id
 ...
 <div id="my_popup" style="position: absolute;  padding:3px; background-color:#006699; width: 1000px; display:none;   " >
                                  ...
                                  <script language='javascript'>
									...
									for($result_count = 0; $result_count < count($post_row_array); $result_count++){
										...
										include "organization_33_detailed_rows_debug.php";
   ...
   <?php if(($_GET["curate"] == "curate" || $curate == "curate") &&  !$_GET["auto_post"]){?>
	...
	?>
		<script>
			...
			$('#dupe_status_2018').html('<div align="center"><font color="#FF6600">มีข้อมูลซ้ำซ้อนในมาตรา 33 หรือ มาตรา 35</font> - กรุณาทำการตรวจสอบข้อมูล  </div>');

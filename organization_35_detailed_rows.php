...
?>
	...
	<tr class="bb_top" id="curator_<?php echo $this_curator_id;?>_alt" bgcolor='#ABB2B9'>
		<td style="border-top:1px solid #999999; "><div align="center"><strong><?php echo $total_records; echo $sub_count_text;?></strong></div></td>
                                              ...
                                              <?php }?>
												 ...
												 <?php 
                                                        if($file_row["file_type"] == "curator_docfile$is_extra_table"){
															...
															if(($this_lawful_year >= 2022 && $this_lawful_year < 2100) || $file_row["file_id"] > 424075){

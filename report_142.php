...
if($_POST["date_from_year"] > 0 && $_POST["date_from_month"] > 0 && $_POST["date_from_day"] > 0){
	...
	$filter_from = " and CreatedDateTime >= '$the_mod_year-$the_month-$the_day 00:00:01'";
}
...
if($_POST["date_to_year"] > 0 && $_POST["date_to_month"] > 0 && $_POST["date_to_day"] > 0){
	...
	$filter_to = " and CreatedDateTime <= '$the_mod_year-$the_month-$the_day 23:59:59'";
}
...
<div align="center">
            <strong>รายงานตรวจสอบการเพิ่มสถานประกอบการของผู้ใช้งานระบบ <?php echo $header_text;?></strong>
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:28px;"<?php }?>>
      ...
      <tr >
        ...
        <td rowspan="2" align="center" valign="bottom"><div align="center" style="vertical-align:middle;"><strong>เพิ่มข้อมูลวันที่</strong></td>
      </tr>
      <tr >
  ...
  ?>
      <tr>
        ...
        <td  valign="top"><div align="right"><?php echo $lawful_row["CreatedDateTime"];?></div></td>

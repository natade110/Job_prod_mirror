...
<?php include "header_html.php";?>
                <td valign="top" style="padding-left:5px;">
                    ...
                    <?php }elseif($mode == "letters" && $have_search_id) { ?>
                            <div style="padding:5px 0 10px 2px"><a href="org_list.php">ค้นหารายชื่อสถานประกอบการ</a> > <a href="organization.php?id=<?php echo $_GET["search_id"];?>&focus=official&year=<?php echo $for_year;?>"><?php echo $company_name_to_use;?></a> > <?php if($type == "hold"){?>
                                    การแจ้งอายัด
                                <?php }else{?>
                                    การส่งจดหมายแจ้งสถานประกอบการ
                                <?php }?>
                    ...
                    <form method="post" action="#org_list" <?php if($mode == "letters" && $type != "hold") {?>onsubmit="return validate_province(this);"<?php }?>>
                    <?php if($mode == "letters") {?>
...
ไม่มีคนรับเอกสาร</span></td><script>						
	...
	doToggleNoRecipientFlag();							
                    ...
                    <?php }elseif($mode == "letters") { ?>
						...
						<?php }else{?>
                             1. ค้นหาสถานประกอบการที่ต้องการส่งจดหมายแจ้ง
                        <?php }?>
	...
	doToggleNoRecipientFlag();							
                    ...
                    <table border="0" width="100%" >
                    	...
                    	<tr>
                            ...
                            <?php if($mode == "letters") { ?>
								...
								<?php if($type == "hold"){?>
                                <div style="padding:10px 0 10px 0; font-weight: bold;">2. เลือกสถานประกอบการที่ต้องการแจ้งอายัด</div>
                                <?php }else{?>
              ...
              <tr>
           	  ...
           	  <td >
						...
						//echo "<br>".$get_org_sql;
						//echo "<br>".$condition_sql;
						//echo "<br>".$lawful_condition;
                        ...
                        <tr bgcolor="#ffffff" align="center" >
                          ...
                          <td>
                            ...
                            <td align="right">
                            	<div align="right"><?php echo number_format(doCleanOutput(default_value($employee_to_use,0)));?></div>                          </td>
                           <td>
                            	<div align="center"><?php //echo $post_row["lawfulness_status"]; 
								echo getLawfulImage(($post_row["lawfulness_status"]));?></div>                         </td>
               ...
               <?php }//if(!$do_hide_company_list) ?>
                ...
                <input name="total_records" type="hidden" value="<?php echo $total_records; ?>" />
                        ...
                        <input name="cur_year" type="hidden" value="<?php echo $cur_year?>">
							...
							;?>"> <strong style="color:#006699">ส่งแจ้งทั้ง <?php echo $record_count_all; ?> สถานประกอบการ</strong>
                           ...
                           <tr>
                             <td><table border="0" style="padding:10px 0 0 50px;" >
                                 <tr>
                                   ...
                                   <div style="padding:5px 0 0 0">
                                   <input name="cur_year" type="hidden" value="<?php echo $cur_year?>">
                                        <input name="send_to_all" type="checkbox" value="<?php echo $condition_sql . " " .$lawful_condition;?>"> <strong style="color:#006699">ส่งแจ้งทั้ง <?php echo $record_count_all; ?> สถานประกอบการ</strong>
                                  </div>
                                   </td>
                                   <td>&nbsp;</td>
                                   <td>&nbsp;</td>

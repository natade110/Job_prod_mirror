...
?>
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:28px;"<?php }?>>
      ...
      <tr >
        ...
        <td ><div align="center" ><strong>CompanyCode</strong> </div></td>
        <td ><div align="center" ><strong>BranchCode</strong> </div></td>
      ...
      <tr>					
        ...
        <td><?php echo $lawful_row["CompanyCode"]?></td>
        <td><?php echo $lawful_row["BranchCode"]?></td>

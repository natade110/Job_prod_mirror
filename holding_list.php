			...
			$the_sql = "
				...
				$the_sql = "
						...
						(
							...
							left outer join docrequestcompany b
							on
							a.RID = b.RID
...
<?php include "header_html.php";?>
                <td valign="top" style="padding-left:5px;">
           	  ...
           	  <td >
                      ...
                      <td>
                            	<div align="center"><span class="column_header">จำนวนสถานประกอบการ</span> </div></td>
                        ...
                        <tr bgcolor="#ffffff" align="center" >
                            ...
                            <td >
                              <div align="center"><a href="view_letter.php?id=<?php echo doCleanOutput($post_row["RID"]);?>&type=hold"><?php echo $total_records;?></a> </div></td>
                            
                       	  <td >
<a href="view_letter.php?id=<?php echo doCleanOutput($post_row["RID"]);?>&type=hold"><?php echo doCleanOutput($post_row["GovDocumentNo"]);?></a>                          </td>
                             <td>
                          ...
                          <td>
                            ...
                            <div align="center"><a href="scrp_delete_doc_request.php?id=<?php echo doCleanOutput($post_row["RID"]);?>&type=hold" title="ลบข้อมูล" onclick="return confirm('คุณแน่ใจหรือว่าจะลบข้อมูล? การลบข้อมูลถือเป็นการสิ้นสุดและคุณจะไม่สามารถเรียกข้อมูลกลับมาได้');"><img src="decors/cross_icon.gif" border="0" /></a> </div></td>

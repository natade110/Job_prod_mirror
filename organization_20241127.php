						...
						?>
							...
							<?php  //bank add 20230106 MA 2022 ข้อ 4  ?>
												   <?php 
																...
																$law_path_file = "https://law.dep.go.thm/law_docfile/"; //when merge need to fix
										  ...
										  <?php 
												...
												<br>ข้อมูลสถานประกอบการที่ได้ทำการส่งข้อมูลดำเนินคดีตามกฏหมายจะแสดงให้ผู้ใช้งานกลุ่มงานคดีแก้ไขได้เท่านั้น
													...
													<form method="post" action="./scrp_do_court_case.php" >
														...
														<input id="urgent_check" name="urgent_check" type="checkbox" value="1" onclick="validateUrgentCase()"/>
														case ด่วนที่สุด
														<br>
	...
	<table  bgcolor="#FFFFFF" width="500" border="1" align="center" cellpadding="3" cellspacing="0" style="border-collapse:collapse;  ">
        ...
        <?php }else{?>
            <tr>
				...
				<td>
				<input name="update_employees_gov_01" id="update_employees_gov_01" style="width:50px" type="text" value="0" /> คน
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
				<input name="update_employees_gov_02" id="update_employees_gov_02" style="width:50px" type="text" value="0" /> คน
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
				<input name="update_employees_gov_03" id="update_employees_gov_03" style="width:50px" type="text" value="0" /> คน
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
                ...
                <td>
				<?php echo formatEmployee($employee_to_use_from_lawful); ?> คน                

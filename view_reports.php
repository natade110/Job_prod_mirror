...
?>
        ...
        <table style="margin:0px 0 0 20px;" cellspacing="20" id="two">
            ...
            <!--
                    ...
                    <tr>
                      ...
                      <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td>จังหวัด</td>
                            <td>
								<?php include "ddl_org_province_report.php";?>
								
								<input name="chk_non_ratio" type="checkbox" value="1" />   แสดงข้อมูลจากสถานประกอบการที่ไม่เข้าข่าย							
					...
					<?php //bank 20221220 add 12.1 report M35  ?>
					<tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">
                      <a href="#" onclick="toggleReport(12_1); return false;">
                            <strong>รายงานที่ 12.1 : สรุปประเภทความพิการที่ทำงานอยู่ในสถานประกอบการ ในมาตรา 35</strong>
                            </a>
                      <form name="report_121_form" id="report_121_form" action="report_12_1.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td>รูปแบบ
                              <select name="report_format" id="report_121_form" onchange="toggleAction(12_1); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="hiddenField2"  value="report_12_1"/></td>
                          </tr>
                          <?php if($sess_accesslevel == 1 || $sess_accesslevel == 2){?>
                          <tr>
                            <td>&nbsp;</td>
						  ...
						  <tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
                            <td colspan="5"><input name="chk_non_ratio" type="checkbox" value="1" />
					...
					<?php //bank 20221220 End add 12.1 report M35  ?>
					
					<tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">
                      <a href="#" onclick="toggleReport(122); return false;">
                            <strong>รายงานที่ 12.2 : สรุปกิจกรรมตามมาตรา 35 </strong>
                            </a>
                      <form name="report_122_form" id="report_122_form" action="report_122.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td>รูปแบบ
                              <select name="report_format" id="report_122_form" onchange="toggleAction(122); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="hiddenField2"  value="report_122"/></td>
                          </tr>
                          <?php if($sess_accesslevel == 1 || $sess_accesslevel == 2){?>
                          <tr>
                            <td>&nbsp;</td>
                      ...
                      <a href="#" onclick="toggleReport(13); return false;">
                            <strong>รายงานที่ 13: สรุปจำนวนลูกจ้างหรือผู้ปฏิบัติงานที่สถานประกอบการหรือหน่วยงานภาครัฐต้องรับตามอัตราส่วนที่กฎหมายกำหนด</strong>
                            </a>
								...
								?>
                            	 ...
                            	 <table width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                        	<?php 											
												include "ddl_curator_event_report.php";											
											?>
                                        </td>
                ...
                <tr>
					...
					<tr>
                      ...
                      <a href="#" onclick="toggleReport(212); return false;">
                            <strong>รายงานที่ 21:  รายการสถานประกอบการที่สถานะการทำตามกฎหมายเปลี่ยนไปหลังจากเริ่มใช้กฎหมายใหม่ปี 2561</strong>
                            </a>
                                          
                      <form name="report_212_form" id="report_212_form" action="report_212.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          
							
                          <tr>
                            <td>ปี </td>
                            <td><?php include "ddl_year_2018up.php";?></td>
                            <td><label>
                              <input name="rad_area" type="radio" id="radio8" value="province" checked="checked" />
                            </label></td>
                            <td>จังหวัด</td>
                            <td><?php include "ddl_org_province_report.php";?></td>
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_212" onchange="toggleAction(212); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="the_report"  value="report_212"/></td>
                          </tr>
					...
					<tr>
                      ...
                      <a href="#" onclick="toggleReport(6122); return false;">
                            <strong>รายงานที่ 22: รายงานรายชื่อสถานประกอบการในระบบที่ไม่มีเลขที่ประจำตัวผู้เสียภาษีอากร 13 หลัก</strong>
                      </a>
					  <form name="report_6122_form" id="report_6122_form" action="report_6122.php" method="post" target="_blank" >
                       <table width="100%" border="0">
                          <tbody><tr>
							<td><label>
                              <input name="rad_area" type="radio" id="radio8" value="province" checked="checked" />
                            ...
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_6122" onchange="toggleAction(6122); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                </select>                            </td>
                            <td><input type="submit" value="เรียกดูรายงาน">
                                <input name="the_report" id="hiddenField2" type="hidden" value="report_6122"></td>
                          </tr>
					...
					<tr>
                      ...
                      <a href="#" onclick="toggleReport(6123); return false;">
                            <strong>รายงานที่ 23: รายงานรายชื่อสถานประกอบการในระบบที่ไม่มีเลขที่ประจำตัวผู้เสียภาษีอากร 13 หลัก และไม่พบชื่อสถานประกอบการจากข้อมูล Web Service กรมพัฒนาธุรกิจการค้า</strong>
                            </a>
							
							<form name="report_6123_form" id="report_6123_form" action="report_6123.php" method="post" target="_blank" >
                       <table width="100%" border="0">
                          <tbody><tr>
							<td><label>
                              <input name="rad_area" type="radio" id="radio8" value="province" checked="checked" />
                            ...
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_6123" onchange="toggleAction(6123); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                </select>                            </td>
                            <td><input type="submit" value="เรียกดูรายงาน">
                                <input name="the_report" id="hiddenField2" type="hidden" value="report_6123"></td>
                          </tr>
                   ...
                   <tr>
					...
					<tr>
                   	  ...
                   	  <td style="line-height:25px">  
							...
							<a href="#" onclick="toggleReport(6130); return false;">
                            <strong>รายงานที่ 30: รายงานการใช้งาน Web Service กรมพัฒนาธุรกิจการค้า</strong>
                            </a>
							
							  <form name="report_6130_form" id="report_6130_form" action="report_6130.php" method="post" target="_blank" >
                    
                    			
                                
									<table width="100%" border="0">
									  <tbody><tr>
										<td>เจ้าหน้าที่จังหวัด</td>
										<td><?php include "ddl_org_province_report.php";?></td>
										<td>รูปแบบ
										  <select name="report_format" id="report_format_22" onchange="toggleAction(22); return false;">
											  <option value="html">html</option>
					...
					<tr>
                      ...
                      <a href="#" onclick="toggleReport(6131); return false;">
                            <strong>รายงานที่ 31: รายงานการใช้งาน Web Service กรมพัฒนาธุรกิจการค้า แบ่งตาม Username</strong>
                            </a>
							
							<form name="report_6131_form" id="report_6131_form" action="report_6131.php" method="post" target="_blank" >
					...
					<tr>
                      ...
                      <a href="#" onclick="toggleReport(6132); return false;">
                            <strong>รายงานที่ 32: รายงานการใช้งาน Web Service กรมพัฒนาธุรกิจการค้า แบ่งตามช่วงสัปดาห์</strong>
                            </a>
							
							<form name="report_6132_form" id="report_6132_form" action="report_6132.php" method="post" target="_blank" >
            ...
            <table style="margin:0px 0 0 20px;" cellspacing="20" id="one">
                      ...
                      <table width="100%" border="0">
                          ...
                          <?php } ?>
						   ...
						   <?php //bank 20221223 add dropdown company type filter ?>
						   <tr>
                        	  <td>&nbsp;</td>
                        	  <td>&nbsp;</td>
                      ...
                      <table width="100%" border="0">
						...
						<tr>
                          ...
                          <td colspan=4>
							  ...
							  <select name="lawful_flag" id="LawfulFlag_search" onChange="doToggleNoRecipientFlag();">								
								<option value="1" >ทำตามกฏหมาย</option>
								<option value="0" >ไม่ทำตามกฏหมาย</option>
								<option value="2" >ปฏิบัติตามกฎหมายแต่ไม่ครบตามอัตราส่วน</option>
								<option value="3" >ไม่เข้าข่ายจำนวนลูกจ้าง</option>
							</select>
				...
				<tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">
                      <a href="#" onclick="toggleReport(6411); return false;">
                      <strong>รายงานที่ 11: ข้อมูลเงินสมทบตามมาตรา 34</strong>
                      </a>
                      
                      <form name="report_6411_form" id="report_6411_form" action="report_6411.php" method="post" target="_blank">
                      <table width="100%" border="0">
                          
						  
						  
						   <tr>
							  <td>สถานะสถานประกอบการ</td>
							  <td colspan=4>

								  <select name="lawful_flag" id="LawfulFlag_search" >								
						  ...
						  <tr>
                            <td >
								...
								<input name="rad_date_range" type="radio" value="lawful" checked />
								
								
								
								ตามปีการปฏิบัติตามกฎหมาย </td>
                            <td colspan="6">
                           ...
                           <tr>
                            <td >
								...
								<input name="rad_date_range" type="radio" value="range" />
								
								
								ตามวันที่การจ่ายเงินในช่วงวันที่</td>
                            <td colspan="6">
						   ...
						   <tr>
								<td >
									...
									<input name="rad_date_range" type="radio" value="month" />


									ตามวันที่การจ่ายเงินในช่วงเดือน</td>
								 <td colspan="6">

									 	<?php $selector_name = "report_6411_";?>
										<select name="<?php echo $selector_name;?>_month" size="1" class="inputf" id="<?php echo $selector_name;?>_month" style="width:auto;" <?php echo $the_disabled;?>>
											...
											<option value="12" <?php if($this_selected_month=="12"){echo "selected='selected'";}?>><?php echo "ธันวาคม"?></option>
									 		 ...
									 		 <select name="<?php echo $selector_name;?>_year" size="1" class="inputf" id="<?php echo $selector_name;?>_year" style="width:auto;" <?php echo $the_disabled;?>>
													<?php 
						    ...
						    <tr>
								<td >
									...
									<input name="rad_date_range" type="radio" value="quarter" />


									ตามวันที่การจ่ายเงินในช่วงไตรมาส</td>
								 <td colspan="6">
									 
									 
									 <?php $selector_name = "report_6411_q";?>
										<select name="<?php echo $selector_name;?>_quarter" size="1" class="inputf" id="<?php echo $selector_name;?>_quarter" style="width:auto;" <?php echo $the_disabled;?>>
											
											<option value="01" <?php if($this_selected_month >= "01" && $this_selected_month <= "03"){echo "selected='selected'";}?>><?php echo "ไตรมาสที่ 1"?></option>
											<option value="02" <?php if($this_selected_month >= "04" && $this_selected_month <= "06"){echo "selected='selected'";}?>><?php echo "ไตรมาสที่ 2"?></option>
											<option value="03" <?php if($this_selected_month >= "07" && $this_selected_month <= "09"){echo "selected='selected'";}?>><?php echo "ไตรมาสที่ 3"?></option>
											<option value="04" <?php if($this_selected_month >= "10" && $this_selected_month <= "12"){echo "selected='selected'";}?>><?php echo "ไตรมาสที่ 4"?></option>
										  </select>
									 		 <select name="<?php echo $selector_name;?>_year" size="1" class="inputf" id="<?php echo $selector_name;?>_year" style="width:auto;" <?php echo $the_disabled;?>>
													<?php 
						  ...
						  <tr>
							  ...
							  <td>
								  รูปแบบ
								  <select name="report_format" id="report_format_6411" onchange="toggleAction(6411); return false;">
									  <option value="html">html</option>
									  <option value="excel">excel</option>
									  <option value="pdf">pdf</option>
									  <option value="words">words</option>
								...
								<td><input name="input5" type="submit" value="เรียกดูรายงาน" />
									<input type="hidden" name="the_report" id="hiddenField2"  value="report_6411"/>
							  </td>
					...
					<?php //bank add 20221221 new report no.12 ?>
					
					<tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">
                      <a href="#" onclick="toggleReport(1222); return false;">
                      <strong>รายงานที่ 12: รายละเอียดสถานประกอบการที่ปฏิบัติตามกฎหมายแล้วทั้งหมด</strong>
                      </a>
                      <form name="report_1222_form" id="report_1222_form" action="report_1222.php" method="post" target="_blank">
                      <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td><?php include "ddl_org_province_report.php";?></td>
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_1222" onchange="toggleAction(1222); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="hiddenField2"  value="report_1222"/></td>
                          </tr>
                          <?php if($sess_accesslevel == 1 || $sess_accesslevel == 2){?>
                          <tr>
                            <td>&nbsp;</td>
				...
				<?php //end add new report no.12 ?>


                <tr>
                    <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                    <td style="line-height:25px">
                        <a href="#" onclick="toggleReport(1333); return false;">
                            <strong>รายงานที่ 13: รายงานที่อยู่จัดส่งใบเสร็จกรณีชำระผ่านระบบ e-service</strong>
                        </a>
                        <form name="report_1333_form" id="report_1333_form" action="report_1333.php" method="post" target="_blank">
                            <table width="100%" border="0">
                                <tr>
                                    <td>ปี </td>
                                    <td><?php
                                    ...
                                    <td><?php include "ddl_org_province_report.php";?></td>
                                    <td>รูปแบบ
                                        <select name="report_format" id="report_format_1333" onchange="toggleAction(1333); return false;">
                                            <option value="html">html</option>
                                            <option value="excel">excel</option>
                                            <option value="pdf">pdf</option>
                                            <option value="words">words</option>
                                    ...
                                    <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                        <input type="hidden" name="the_report" id="hiddenField2"  value="report_1333"/>
                                    </td>
                                </tr>
                                <?php if($sess_accesslevel == 1 || $sess_accesslevel == 2){?>
                                    <tr>
		...
		<?php //bank add 20221221 new report no.24 ?>
                    <tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">  
                      
                      <a href="#" onclick="toggleReport(424); return false;">
                            <strong>รายงานที่ 24: รายงานสถานประกอบการที่เข้าข่ายต้องถูกส่งดำเนินคดี เนื่องจากคดีใกล้หมดอายุ</strong>
					</a>
                                          
                      <form name="report_424_form" id="report_424_form" action="report_424.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          <tr>
                            ...
                            <td><label>
                              <input name="rad_area" type="radio" id="radio8" value="province" checked="checked" />
								...
								จังหวัด   <?php include "ddl_org_province_report.php";?> รูปแบบ  <select name="report_format" id="report_format_424" onchange="toggleAction(424); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
								...
								<input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="the_report"  value="report_424"/>
						  ...
						  <tr>
                            ...
                            <td><input type="radio" name="rad_area" id="radio9" value="section" /> ภาค  <?php include "ddl_org_section_report.php";?></td>
 
						  <?php } ?>
						  </tr>

                          <tr>
						   <td>ระยะเวลาหมดอายุความ:
                              <select name="type_format" id="report_format_424" onchange="toggleAction(424); return false;">
								  <option value="All">แสดงทั้งหมด</option>
								  <option value="Ex_2_year">หมดอายุความ 2 ปี </option>
                                  <option value="Ex_1_year">หมดอายุความ 1 ปี </option>
                                  <option value="Ex_8_month">หมดอายุความ 8 เดือน</option>
                                </select>                            
							</td>
                          </tr>
					...
					<?php //yoes 20220105 --> add new report for คดี here?>
					<?php //bank add 20230105 new report for only sent to law system ?>
				    <tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">  
                      
                      <a href="#" onclick="toggleReport(425); return false;">
                            <strong>รายงานที่ 25: รายชื่อสถานประกอบการที่ส่งเรื่องไปยังระบบการติดตามและดำเนินคดี </strong>
					</a>
                                          
                      <form name="report_425_form" id="report_425_form" action="report_425.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          <tr>
                            <td>ปี </td>
                            <td><?php include "ddl_year_all.php";?></td>
                            <td><label>
                              <input name="rad_area" type="radio" id="radio8" value="province" checked="checked" />
                            </label></td>
                            <td>จังหวัด</td>
                            <td><?php include "ddl_org_province_report.php";?></td>
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_425" onchange="toggleAction(425); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="the_report"  value="report_425"/></td>
                          </tr>
                          <?php if($sess_accesslevel == 1 || $sess_accesslevel == 2){?>
                          <tr>
                            <td>&nbsp;</td>
                     ...
                     <?php //bank add 20230108 New report for list of request to change emp from law_system ?>
				    <tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">  
                      
                      <a href="#" onclick="toggleReport(426); return false;">
                            <strong>รายงานที่ 26: log request การขอแก้ไขข้อมูลจำนวนเงินและลูกจ้าง ก่อนส่งฟ้องคดีจากระบบการติดตามและดำเนินคดี  </strong>
					</a>
                                          
                      <form name="report_426_form" id="report_426_form" action="report_426.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          <tr>
                            <td>ปี </td>
                            <td><?php include "ddl_year_all.php";?></td>
                            ...
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_426" onchange="toggleAction(426); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="the_report"  value="report_426"/></td>
                          </tr>
					...
					<?php //bank add 20230108 report 427 ?>
				    <tr>
                   	  <td valign="top"><img src="decors/pdf_small.jpg" /></td>
                   	  <td style="line-height:25px">  
                      
                      <a href="#" onclick="toggleReport(427); return false;">
                            <strong>รายงานที่ 27: รายชื่อสถานประกอบการที่ยังไม่ส่งข้อมูลให้ระบบการติดตามและดำเนินคดี  </strong>
					</a>
                                          
                      <form name="report_427_form" id="report_427_form" action="report_427.php" method="post" target="_blank" >
                      <table width="100%" border="0">
                          <tr>
                            <td>ปี <?php include "ddl_year_all.php";?> </td>
                            <td><label>
                              <input name="rad_area" type="radio" id="radio8" value="province" checked="checked" />
                            </label></td>
                            <td>จังหวัด</td>
                            <td><?php include "ddl_org_province_report.php";?></td>
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_427" onchange="toggleAction(427); return false;">
                                  <option value="html">html</option>
                                  <option value="excel">excel</option>
                                  <option value="pdf">pdf</option>
                                  <option value="words">words</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="the_report"  value="report_427"/></td>
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><input type="radio" name="rad_area" id="radio9" value="section" /></td>
                            <td>ภาค <?php include "ddl_org_section_report.php";?></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <?php } ?>
						  ...
						  <tr>
							<td>สถานะการส่งคดี:
                              <select name="cour_sent_format" id="report_format_427" onchange="toggleAction(427); return false;">
								  <option value="0">ดูทั้งหมด</option>
								  <option value="1">ดูที่ส่งแล้ว</option>
								  <option value="2">ดูที่ยังไม่ส่ง</option>
                                </select>                            </td>
                          </tr> */?>
...
function toggleReport(what){
	...
	document.getElementById("report_1222_form").style.display = "none";
    document.getElementById("report_1333_form").style.display = "none";
	...
	document.getElementById("report_121_form").style.display = "none";
	document.getElementById("report_122_form").style.display = "none";
	...
	document.getElementById("report_6122_form").style.display = "none";
	document.getElementById("report_6123_form").style.display = "none";
	document.getElementById("report_6130_form").style.display = "none";
	document.getElementById("report_6131_form").style.display = "none";
	document.getElementById("report_6132_form").style.display = "none";
	...
	document.getElementById("report_424_form").style.display = "none";
	document.getElementById("report_425_form").style.display = "none";
  document.getElementById("report_426_form").style.display = "none";
	document.getElementById("report_427_form").style.display = "none";
	...
	document.getElementById("report_212_form").style.display = "none";
	
	$("#report_6411_form").hide();

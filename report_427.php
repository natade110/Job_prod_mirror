...
if($_POST["ddl_year"]){
	...
	$year_selected = "AND b.Year = $year_selected";
...
<div align="center">
	<strong>รายชื่อสถานประกอบการที่ยังไม่ส่งข้อมูลให้ระบบการติดตามและดำเนินคดี</strong>
	<br />
	<br />
</div>
...
<table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:18px;"<?php }?>>
      ...
      <tbody>
      <?php
		  $lawful_result = mysql_query($main_sql1_1);	

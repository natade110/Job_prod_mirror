...
<table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:18px;"<?php }?>>
      ...
      <tr >
        ...
        <td colspan="2" align="center" valign="bottom" ><div align="center"><strong>สถานะการแสดงผลผิล</strong></div></td>
        </tr>
      <tr >
      ...
      <?php
		  ...
		  while ($lawful_row = mysql_fetch_array($lawful_result)) {
			...
			if(
				...
				$the_status .= $lawful_row[Hire_status]."x".$lawful_row[le_count]."x"
								.$lawful_row[Hire_NumofEmp]."x".$lawful_row[Conc_status]."x"
								.$lawful_row[curator_count]."x".$lawful_row[pay_status]."x"
								.$lawful_row[payment_count]."x".$lawful_row[LawfulStatus];

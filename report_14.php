...
<div align="center">
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:28px;"<?php }?>>
      ...
      <tr >
        ...
        <td rowspan="2" align="center" valign="bottom"><strong>แก้ไขในปี</strong></td>
      </tr>
      <tr >
  ...
  ?>
      <tr>
        ...
        <td  valign="top"><div align="center"><?php 
			...
			if($lawful_row["last_modified_lid_year"]){
				echo $lawful_row["last_modified_lid_year"]+543;
			}
			?></div></td>

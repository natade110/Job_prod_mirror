...
<div align="center">
  <strong>สถิติการปฏิบัติตามกฎหมายของสถานประกอบการเอกชน <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?><br />สำนักงานส่งเสริมและพัฒนาคุณภาพชีวิตคนพิการแห่งชาติ</strong>
              <br>
</div>
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:28px;"<?php }?>>
      ...
      <tr >
        ...
        <td  colspan="6" ><div align="center"><strong>นายจ้างหรือสถานประกอบการ</strong></div></td>
        </tr>
      <tr >
        ...
        <td  rowspan="3" valign="middle"><div align="center"><strong>ส่งเงิน<br>
          เข้า<br>
          กองทุน<br>
        (บาท)</strong></div></td>
        </tr>
      ...
      <tr >
        ...
        <td colspan="7"  valign="top"><div align="left"><strong>ปฏิบัติตามกฎหมายครบตามอัตราส่วน</strong></div></td>
        </tr>
      </thead>
				...
				$choice_prefix = ""; //remove prefix
			 	...
			 	?>
                  <tr>
                    ...
                    <td  <?php echo $footer_row?>><div align="right"><strong><?php echo formatEmployeeReport($total_company);?></strong> </div></td>
                    <td  <?php echo $footer_row?>><div align="right"><strong><?php echo formatNumberReport($total_percent);?></strong> </div></td>
                    ...
                    <td  <?php echo $footer_row?>><div align="right"><strong><?php echo formatMoneyReport($sum_rule_35);?></strong> </div></td>
                  </tr>
              <?php }?>
      ...
      <tr>
        ...
        <td  valign="top"><div align="right"><?php echo formatNumberReport($this_percent);?> </div></td>
        ...
        <td  valign="top"><div align="right"><?php echo formatMoneyReport($this_rule_35); //echo $rule_35_sql;?></div></td>
        </tr>

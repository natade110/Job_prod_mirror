              ...
              <table cellspacing="0">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="tab_history_black" class="white_on_black" style="width:160px; display:none;" align="center">ประวัติการปฎิบัติตามกฎหมาย</div>
                                      <div id="tab_history_grey" class="white_on_grey" style="width:160px; " align="center">ประวัติการปฎิบัติตามกฎหมาย</div>
                                      </a>
                                  </td>
                    ...
                    <table border="1" width="100%" cellspacing="0" cellpadding="5" style="border-collapse:collapse; ">
                    	<tr bgcolor="#9C9A9C" align="center" >
                    	  <td><div align="center"><span class="column_header">ปี</span> </div></td>
                            ...
                            <td>
                            	<div align="center"><span class="column_header">จำนวนลูกจ้าง</span> </div>
                            </td>
                            
                             <td>
                            	<div align="center"><span class="column_header">อัตราส่วน</span> </div>
                            </td>
							...
							?>
                                ...
                                <tr >
                                  <td>
                                    ...
                                    <td >
                                   	 <div align="right"><?php echo $employees_to_use;?></div>
                                    </td>    
                                    ...
                                    <div align="center">
                                        <?php echo $ratio_to_use;?> ต่อ 1 = <?php echo $final_employee;?> ราย
                                    </div>
                                    ...
                                    <td >
                                    <div align="right"><?php echo $lawful_row["Hire_NumofEmp"]?></div>
                                    </td>
                                    ...
                                    <td >
                                   	 	<div align="right"><?php echo $curator_usee;?></div>
                                    
                                    </td>
                                    
                                    <td >
                                    
                                    	<div align="center"><?php echo getLawfulImage($lawful_row["LawfulStatus"]);?></div>
                                    </td>
                                </tr>
                                            ...
                                            <?php 
												...
												?>
                                                         ...
                                                         <?php if($sess_accesslevel != 4){?>
                                                            ...
                                                            ดอกเบี้ย ณ วันที่จ่าย: <?php echo $interest_date;?> วัน x 7.5/100/365 x <?php echo formatNumber($owned_money);?> = <?php echo formatNumber($interest_money - $total_pending_interest);?> บาท
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="curator_is_disable" id="curator_is_disable">
                                    <option value="0">ผู้ดูแลคนพิการ</option>
                                    <option value="1">คนพิการ</option>
        ...
        <table width="750">
			...
			?>
                 <tr >
                  ...
                  <td style="border-top:1px solid #999999;"><?php if($post_row["curator_is_disable"] == 1){echo "คนพิการ";}else{echo "ผู้ดูแลคนพิการ";}?></td>
                  ...
                  <td style="border-top:1px solid #999999;"><?php echo formatDateThai($post_row["curator_start_date"]);?></td>
                   ...
                   <td style="border-top:1px solid #999999;"><?php echo doCleanOutput($post_row["curator_event"]);?></td>
                    <td style="border-top:1px solid #999999;"><?php 
							...
							?>
                            	<a href="hire_docfile/<?php echo $curator_file_path;?>">ไฟล์แนบ</a>
                            <?php

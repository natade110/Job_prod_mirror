...
if($is_2013){
		...
		$main_sql = "
				...
				company.companyCode = e.the_sub_companycode
				and
...
<div align="center">
            <strong>สถานประกอบการที่ไม่เข้าข่ายจำนวนลูกจ้างตามกฎหมาย <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?><br />สำนักงานส่งเสริมและพัฒนาคุณภาพชีวิตคนพิการแห่งชาติ</strong>
              <br>
</div>

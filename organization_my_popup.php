<div id="my_popup" class="modal bs-example-modal-lg-m33" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none; overflow: scroll;">
                                  ...
                                  <script language='javascript'>
                                    ...
                                    <tr>
									  ...
									  <?php //if($sess_userid == 22446){echo "x".$sess_userid;} ?>
									  <?php //if($sess_userid == 22446){echo "x".$sess_accesslevel;} ?>
									  <?php //if($sess_userid == 22446){echo "x".$is_read_only;} ?>
                                           ...
                                           <tr>
                                            ...
                                            <font color="red">*</font>
                                               ...
                                               <?php if($sess_accesslevel == "6" || $sess_accesslevel == "7"){
                                                   ...
                                                   //see if have meta
                                                   $le_gov_position = getFirstItem("select meta_value_char from lawful_employees_meta where meta_for = 'le_gov_position' and meta_leid = '".($leid_row["le_id"])."'");


                                                    //if(1==0){?>
                                                   <td class="td_left_pad">ตำแหน่ง</td>
                                                   <td><input name="le_gov_position" type="text" id="le_gov_position" value="<?php echo  $le_gov_position;?>" maxlength="255"/></td>
                                               <?php }else{ ?>
                                                    <td class="td_left_pad"></td>
                                                    <td></td>
                                               <?php }?>
...
function formSubmit(){
	...
	$.ajax({
        ...
        error: function(xhr, status, error) {
            // Re-enable submit button if request fails
            $("#button3").prop('disabled', false);
